    ...
    return (
        <div>
            <section className='section'>
                <h1 className='h1'>Nature</h1>
                <div class="content">
                    <p className='p'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Minus, laborum suscipit doloremque, expedita voluptatum maiores corporis modi assumenda esse consectetur error nulla, vero alias.</p><a href="">Learn more</a>
                </div>
            ...
            <a class="attribution" href="https://dribbble.com/shots/3104643-Fire-Ice-Website">Original dribbble shot</a>
        </div>
