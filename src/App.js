  ...
  return (
    <BrowserRouter>
      <Routes>
        ...
        <Route path="/AdminCategory/:id" element={<Private Item={AdminCategory} />} />
        <Route path="/RegisterRestaurant/:id" element={<Private Item={RegisterRestaurant} />} />
        <Route path="/RegisterDrink/:id" element={<Private Item={RegisterDrink} />} />  
